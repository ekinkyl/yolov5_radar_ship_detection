...
for i in range(0, len(images), CHUNK_SIZE):
    ...
    chunks.append({"images": chunk_imgs, "labels": chunk_labels, "objects": total_objects})
...
for chunk in chunks:
    ...
    best_split = min(SPLIT_RATIOS.keys(), key=lambda s: current_counts[s] / target_counts[s])
